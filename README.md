...
- `Data fetching` - React Query - React Query	Fetching, caching, mutations
- `UI/local state` - Zustand - View mode, filters, modals
...
3. `npm install`  
4. Create a `Firebase` project and enable `Firestore`, `Firebase Authentication` (Google), and `Firebase Storage`.
